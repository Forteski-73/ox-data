...
class SetupPage extends StatefulWidget {
  /// Serviço principal: expõe inventoryRepository e database usados nas
  /// etapas de "Baixando configurações" e "Sincronizando produtos".
...
class _SetupPageState extends State<SetupPage> {
  static const _steps = [
    ...
    SetupStep(
      ...
      title:     'Baixando configurações',
      subtitle:  'Máscaras, setores e parâmetros',
    ),
    SetupStep(
  ...
  /// Usa um GET real no backend (User/api) em vez de apenas checar a
  /// interface de rede, conforme recomendado.
  ...
  /// Etapa 3 — Baixando configurações
  /// Sincroniza máscaras/setores/parâmetros (aguardando o término, ao
  /// contrário do fire-and-forget usado em outros pontos do app).
  Future<void> _downloadSettings() async {
    await widget.inventoryService.syncMasks();
  }

  /// Etapa 4 — Sincronizando produtos
  ...
  Future<void> _syncProducts() async {
    ...
    for (var page = 1; page <= totalPages; page++) {
      ...
      setState(() {
        ...
        _progress = (3 + (page / totalPages)) / _steps.length;
      });
    }
  }
      ...
      children: [
        AnimatedContainer(
          ...
          child: AnimatedSwitcher(
            ...
            child: Icon(
              step.icon,
              key: ValueKey(step.icon), // Chave para o AnimatedSwitcher identificar a mudança de ícone
              color: step.iconColor, // usa a cor do ícone dinâmica da lista
              size: 28,
            ),
          ),
        ),
      ...
      child: Container(
        ...
        child: const Row(
          children: [
            ...
            Expanded(
              child: Text(
                'Tudo pronto para iniciar a contagem!',
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w500,
                  color: Color(0xFF1E6F3D),
